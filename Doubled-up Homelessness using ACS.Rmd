---
title: "R code for Measuring Doubled-Up Homelessness using ACS Microdata"
Author: Rachel G. Mckane
...
Next we  construct new variables needed for the doubling up measure. In this sample code, 1086 represents the national median gross rent for 2019 for a 2 bedroom, but this should be updated based on the sample year, if not 2019 (Use Census TableID: B25031).

```{r defining doubled up based on relationship, crowding, and adjusted poverty level}
